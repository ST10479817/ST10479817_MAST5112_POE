...
const styles = StyleSheet.create({
    bin:{ color: 'red', marginTop: 5, textAlign: 'right' },
  ...
  title: { fontSize: 22, fontWeight: 'bold', color: '#2196f3', paddingBottom: 10 },
    mainContent: { fontSize: 18, marginBottom: 10, padding: 10, borderRadius: 8,   borderBlockColor: '#000000ff', borderWidth:  1},
  subtitle: { fontSize: 20, marginVertical: 10,  textDecorationLine: 'underline',},
  input: { overflow: 'hidden', borderWidth: 1, borderColor: '#000000ff', borderRadius: 8, padding: 10, marginBottom: 10},
    pickerContainer: {
    borderWidth: 1,
  ...
  picker: { backgroundColor: '#f1f2f4', height: 50,
    width: '100%', },
  button: { backgroundColor: '#49b24d', padding: 10, borderRadius: 8, alignItems: 'center' },
  buttonText: { color: '#fff', fontWeight: 'bold', fontSize: 20},
  card: { borderWidth: 1, borderRadius: 10, padding: 10, marginBottom: 10,   borderBlockColor: '#000000ff' },
